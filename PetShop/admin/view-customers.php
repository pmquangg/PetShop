...
if (!empty($_SESSION['current_admin'])) {
        ...
        $products = mysqli_query($conn, "select * from user ");
    mysqli_close($conn);
}
    ?>
  <?php
                     ...
                     <tbody>
                        <tr>
                          ...
                          <!--   <td ><?= $row['title'] ?></td> -->
                            ...
                            <td data-label="Sửa" class="right__iconTable"><a href="./cap-nhat-nguoi-dung.php?id=<?= $row['id'] ?>"><img src="assets/icon-edit.svg" alt=""></a></td>
                            <td data-label="Xoá" class="right__iconTable"><a href="./xoa-nguoi-dung.php?id=<?= $row['id'] ?>"><img src="assets/icon-trash-black.svg" alt=""></a></td>
                        </tr>
                 <?php } ?>
                                <!--     <tbody>
                                        <tr>
