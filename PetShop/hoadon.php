...
<script src="../resources/ckeditor/ckeditor.js"></script>
    ...
    <body>
        ...
        if (!empty($_SESSION['current_user'])) {
            include 'config.php';
            $orders = mysqli_query($conn, "SELECT orders.*, order_detail.*, post.kind
FROM orders
...
<div id="page" class="page">
    <div class="header">
       ...
       <div class="logo"><img src="image/logo.png"/></div>
        <div class="company">Cửa Hàng Thú Cưng PetShop</div><br>
        <div class="company">Mã số thuế:1221343444</div><br>
        <div class="company">Đia chỉ: 16 Lạc Trung, 2 Bà Trưng, Hà Nội</div>
    </div>
  <br/>
  <div class="title">
...
$tongsotien = 0;
    ...
    foreach($orders as $row)
    {
        ...
        echo "<td class=\"cotGia\">".number_format(($row['price']),0,",",".")."</td>";
...
?>
    <tr>
      ...
      <td class="tong"><?php echo number_format(($tongsotien),0,",",".")?></td>
    </tr>
  </table>
